          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                You don't have permission to access this page. Only admin users can manage chauffeur services.
              </p>
            </div>
          </CardContent>
        </Card>
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 mt-24">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Chauffeur Service Management</h1>
            <p className="text-gray-600 mt-2">
              Manage all chauffeur service types in the system. Only visible to admin users.
            </p>
          </div>
                    ...
                    <div className="flex items-start gap-4 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-600 mb-1">
                          <strong>Service Type:</strong> {restaurant.cuisine}
                        </p>
                        <p className="text-sm text-gray-600 mb-1">
                          <strong>Service Area:</strong> {restaurant.address}
                        </p>
                        {restaurant.phone && (
                          <p className="text-sm text-gray-600 mb-1">
