...
// Map internal business IDs to CRM business IDs
const BUSINESS_ID_MAP: { [key: string]: string } = {
  '24e2799f-60d5-4e3b-bb30-b8049c9ae56d': '6c5d19b9-e75c-48e6-a894-ca33882a0304',
  // Add more mappings as needed
};

// Default CRM business ID to use if no mapping is found
const DEFAULT_BUSINESS_ID = '6c5d19b9-e75c-48e6-a894-ca33882a0304';
...
serve(async (req: Request) => {
  ...
  try {
    ...
    else if (customerData.restaurantId && BUSINESS_ID_MAP[customerData.restaurantId]) {
      crmBusinessId = BUSINESS_ID_MAP[customerData.restaurantId];
    ...
    const source = isNewCustomer ? 'chauffeur_new_customer' : 'chauffeur_booking';
    ...
    const crmPayload = {
      ...
      source_app: source, // Add the source app identifier
